...
namespace MVCTutoialApp.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewID,AlbumID,Content,ReviewerEmail")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewID,AlbumID,Content,ReviewerEmail")] Review review)
        {
            if (ModelState.IsValid)
            {
